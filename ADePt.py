...
class Discriminator(nn.Module):
    def __init__(self, input_nc, ndf=32, n_layers=5, norm_layer=nn.BatchNorm3d):
        ...
        sequence += [nn.Conv3d(ndf * nf_mult, 1, kernel_size=kw, stride=1, padding=padw), nn.Sigmoid()]  # output 1 channel prediction map
